...
- **Project Charter:** first-run signable charter modal (name, exam date, why, canvas signature) stored in `progress.charter`; `window.openCharter()` reopens it. Commitment-psychology feature — don't remove the signature pad.
